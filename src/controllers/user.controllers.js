...
const refreshTokenAccess = (asyncHandler(async () => {
  ...
  try {
    ...
    if (incomingRefreshToken !== user?.refreshToken) throw ApiError(401, 'Refresh token is expired or used');
...
const updateUserCoverImage = asyncHandler(async (req, res) => {
  ...
  if (!coverImage.url) throw new ApiError('Error while uploading Cover Image on cloudinary');
...
export {
  registerUser, loginUser, logoutUser, refreshTokenAccess, changeCurrentPassword, updateAccountDetails, getCurrentUser, updateUserAvatar, updateUserCoverImage, getUserChannelProfile, getWatchHistory
};
